...
if __name__ == "__main__":
    ...
    print(agent.load_and_simulate("./DQN_%dlyr_%dhid_%ddis_%.5flr_%dit_%dba" % (num_layers, discard_memory, hidden_dim, lr, itera, batch), simulate_num), num_games=simulate_num)
